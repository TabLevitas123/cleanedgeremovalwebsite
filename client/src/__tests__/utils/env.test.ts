import { getEnvVar, getFeatureFlag, isDevelopment, isProduction, isTest } from '../../utils/env';
...
describe('Environment Utility', () => {
  ...
  describe('getEnvVar', () => {
    ...
    it('should convert string to number when default value is a number', () => {
      ...
      const result = getEnvVar('TEST_NUMBER', 0);
    ...
    it('should convert string to boolean when default value is a boolean', () => {
      ...
      const resultTrue = getEnvVar('TEST_BOOL_TRUE', false);
      const resultFalse = getEnvVar('TEST_BOOL_FALSE', true);
    ...
    it('should parse JSON when default value is an object', () => {
      ...
      const result = getEnvVar('TEST_OBJECT', {});
    ...
    it('should return default value when JSON parsing fails', () => {
      ...
      const result = getEnvVar('TEST_OBJECT', defaultValue);
    ...
    it('should parse JSON when default value is an array', () => {
      ...
      const result = getEnvVar('TEST_ARRAY', []);
  ...
  describe('getFeatureFlag', () => {
    it('should return true when feature flag is set to true', () => {
      ...
      const result = getFeatureFlag('TEST_FLAG');
    ...
    it('should return default value when feature flag is not set', () => {
      ...
      const resultWithDefaultTrue = getFeatureFlag('TEST_FLAG', true);
      const resultWithDefaultFalse = getFeatureFlag('TEST_FLAG', false);
