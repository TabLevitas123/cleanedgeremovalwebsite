...
const RegisterPage: React.FC = () => {
  ...
  const getPasswordStrengthColor = () => {
    ...
    if (score === 0) return 'bg-error-color';
    if (score === 1) return 'bg-error-color';
    if (score === 2) return 'bg-warning-color';
    if (score === 3) return 'bg-warning-color';
    if (score === 4) return 'bg-success-color';
    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary-color dark:bg-neutral-800 dark:text-neutral-200 dark:border-neutral-600 ${
                errors.firstName ? 'border-error-color' : 'border-neutral-300'
              }`}
              placeholder="John"
              disabled={isLoading}
            ...
            />
            {errors.firstName && (
              <p id="firstName-error" className="mt-1 text-sm text-error-color">
                {errors.firstName}
              </p>
            )}
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary-color dark:bg-neutral-800 dark:text-neutral-200 dark:border-neutral-600 ${
                errors.lastName ? 'border-error-color' : 'border-neutral-300'
              }`}
              placeholder="Doe"
              disabled={isLoading}
            ...
            />
            {errors.lastName && (
              <p id="lastName-error" className="mt-1 text-sm text-error-color">
                {errors.lastName}
              </p>
            )}
          </div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              onChange={handleChange}
              className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary-color dark:bg-neutral-800 dark:text-neutral-200 dark:border-neutral-600 ${
                errors.confirmPassword ? 'border-error-color' : 'border-neutral-300'
              }`}
              placeholder="••••••••"
              disabled={isLoading}
          ...
          {errors.confirmPassword && (
            <p id="confirmPassword-error" className="mt-1 text-sm text-error-color">
              {errors.confirmPassword}
            </p>
          )}
        </div>
        ...
        <div className="flex items-start mt-4">
          ...
          <div className="ml-3 text-sm">
            ...
            >
              I agree to the{' '}
              <Link to="/terms-of-service" className="text-primary-color hover:text-primary-light">
                Terms of Service
              </Link>{' '}
              and{' '}
              <Link to="/privacy-policy" className="text-primary-color hover:text-primary-light">
                Privacy Policy
              </Link>
            </label>
            {errors.agreeToTerms && (
              <p id="agreeToTerms-error" className="mt-1 text-sm text-error-color">
                {errors.agreeToTerms}
              </p>
            )}
          </div>
      ...
      <div className="text-center mt-8">
        <p className="text-neutral-600 dark:text-neutral-400">
          ...
          <Link to="/login" className="text-primary-color hover:text-primary-light">
            Sign in
          </Link>
        </p>
      </div>
