        ...
        >
          ...
          >
            <div className="w-20 h-20 rounded-full bg-primary-light/20 flex items-center justify-center mb-6">
              <Icon name="calendar" size="large" className="text-primary-color" />
            </div>
          ...
          >
            <div className="w-20 h-20 rounded-full bg-primary-light/20 flex items-center justify-center mb-6">
              <Icon name="dollar-sign" size="large" className="text-primary-color" />
            </div>
            <h3 className="text-2xl font-semibold text-neutral-800 dark:text-neutral-200 mb-3 font-montserrat">
              2. Get a Quote
            </h3>
          ...
          >
            <div className="w-20 h-20 rounded-full bg-primary-light/20 flex items-center justify-center mb-6">
              <Icon name="check-circle" size="large" className="text-primary-color" />
            </div>
            <h3 className="text-2xl font-semibold text-neutral-800 dark:text-neutral-200 mb-3 font-montserrat">
              3. Relax
            </h3>
