...
const validationSchema = Yup.object().shape({
    ...
    'is-valid-phone-or-empty', phoneErrorMsg, (value) => !value || phoneRegexRequired.test(value) // Pass if falsy (empty/null/undefined) OR if regex matches
    ),
    ...
    otherDescription: Yup.string()
        .when('services', {
        is: (services) => Array.isArray(services) && services.includes('Other'),
...
const SchedulingContactSection = () => {
    const dispatch = (0, react_redux_1.useDispatch)();
    const [submitQuoteRequest, { isLoading, isSuccess, isError, error }] = (0, api_1.useSubmitQuoteRequestMutation)();
    // Form state
    ...
    const [showOtherDescription, setShowOtherDescription] = (0, react_1.useState)(false);
    ...
    const handleServiceChange = (0, react_1.useCallback)((e) => {
    ...
    const handleBlur = (0, react_1.useCallback)(async (e) => {
    ...
    return (<section className="py-16 md:py-24 bg-gradient-to-b from-primary-light/10 to-white dark:from-neutral-800 dark:to-neutral-900">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-white dark:bg-neutral-800 p-8 rounded-lg shadow-lg">
            {/* Request Quote Form */}
            {!isAutoScheduleMode && (<form onSubmit={handleSubmit} onReset={handleReset} noValidate>
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input type="text" id="fullName" name="fullName" required placeholder="Name*" className={`mt-1 block w-full px-3 py-2 border rounded-md shadow-sm placeholder-neutral-400/60 focus:outline-none focus:ring-primary-color focus:border-primary-color sm:text-sm dark:bg-neutral-700 dark:text-white dark:placeholder-neutral-500/60 ${errors.fullName ? 'border-red-500 dark:border-red-400' : 'border-neutral-300 dark:border-neutral-600'}`} value={formData.fullName} onChange={handleChange} onBlur={handleBlur} aria-invalid={errors.fullName ? "true" : "false"} aria-describedby={errors.fullName ? "fullName-error" : undefined}/>
                  ...
                  <div>
                    ...
                    <input type="text" id="serviceAddress" name="serviceAddress" required placeholder="Address*" className={`mt-1 block w-full px-3 py-2 border rounded-md shadow-sm placeholder-neutral-400/60 focus:outline-none focus:ring-primary-color focus:border-primary-color sm:text-sm dark:bg-neutral-700 dark:text-white dark:placeholder-neutral-500/60 ${errors.serviceAddress ? 'border-red-500 dark:border-red-400' : 'border-neutral-300 dark:border-neutral-600'}`} value={formData.serviceAddress} onChange={handleChange} onBlur={handleBlur} aria-invalid={errors.serviceAddress ? "true" : "false"} aria-describedby={errors.serviceAddress ? "serviceAddress-error" : undefined}/>
                  ...
                  <div>
                    ...
                    <input type="email" id="email" name="email" required placeholder="Email*" className={`mt-1 block w-full px-3 py-2 border rounded-md shadow-sm placeholder-neutral-400/60 focus:outline-none focus:ring-primary-color focus:border-primary-color sm:text-sm dark:bg-neutral-700 dark:text-white dark:placeholder-neutral-500/60 ${errors.email ? 'border-red-500 dark:border-red-400' : 'border-neutral-300 dark:border-neutral-600'}`} value={formData.email} onChange={handleChange} onBlur={handleBlur} aria-invalid={errors.email ? "true" : "false"} aria-describedby={errors.email ? "email-error" : undefined}/>
                  ...
                  <div>
                    ...
                    <input type="tel" id="cellPhone" name="cellPhone" required placeholder="Cell Phone Number*" className={`mt-1 block w-full px-3 py-2 border rounded-md shadow-sm placeholder-neutral-400/60 focus:outline-none focus:ring-primary-color focus:border-primary-color sm:text-sm dark:bg-neutral-700 dark:text-white dark:placeholder-neutral-500/60 ${errors.cellPhone ? 'border-red-500 dark:border-red-400' : 'border-neutral-300 dark:border-neutral-600'}`} value={formData.cellPhone} onChange={handleChange} onBlur={handleBlur} aria-invalid={errors.cellPhone ? "true" : "false"} aria-describedby={errors.cellPhone ? "cellPhone-error" : undefined}/>
                  ...
                  <div>
                    ...
                    <input type="tel" id="homePhone" name="homePhone" placeholder="Home Phone Number" className={`mt-1 block w-full px-3 py-2 border rounded-md shadow-sm placeholder-neutral-400/60 focus:outline-none focus:ring-primary-color focus:border-primary-color sm:text-sm dark:bg-neutral-700 dark:text-white dark:placeholder-neutral-500/60 ${errors.homePhone ? 'border-red-500 dark:border-red-400' : 'border-neutral-300 dark:border-neutral-600'}`} value={formData.homePhone} onChange={handleChange} onBlur={handleBlur} aria-invalid={errors.homePhone ? "true" : "false"} aria-describedby={errors.homePhone ? "homePhone-error" : undefined}/>
                  ...
                  <div>
                    ...
                    <input type="tel" id="workPhone" name="workPhone" placeholder="Work Phone Number" className={`mt-1 block w-full px-3 py-2 border rounded-md shadow-sm placeholder-neutral-400/60 focus:outline-none focus:ring-primary-color focus:border-primary-color sm:text-sm dark:bg-neutral-700 dark:text-white dark:placeholder-neutral-500/60 ${errors.workPhone ? 'border-red-500 dark:border-red-400' : 'border-neutral-300 dark:border-neutral-600'}`} value={formData.workPhone} onChange={handleChange} onBlur={handleBlur} aria-invalid={errors.workPhone ? "true" : "false"} aria-describedby={errors.workPhone ? "workPhone-error" : undefined}/>
                  ...
                  <fieldset>
                    ...
                    <div className="space-y-2">
                      {availableServices.map((service) => (<div key={service} className="relative flex items-start">
                          <div className="flex items-center h-5">
                            <input id={`service-${service.toLowerCase().replace(/\s+/g, '-')}`} name="services" type="checkbox" value={service} checked={formData.services.includes(service)} onChange={handleServiceChange} className="absolute h-4 w-4 opacity-0 peer" aria-describedby={errors.services ? "services-error" : undefined}/>
                            <div className="h-4 w-4 rounded-full border border-neutral-300 dark:border-neutral-600 bg-white dark:bg-neutral-700 peer-checked:bg-primary-color peer-checked:border-primary-color peer-focus:ring-2 peer-focus:ring-offset-2 peer-focus:ring-primary-color transition-colors duration-150 ease-in-out" aria-hidden="true"></div>
                          </div>
                      ...
                      {showOtherDescription ? (<div className="mt-2 pl-7">
                          ...
                          <textarea id="otherDescription" name="otherDescription" rows={3} required={showOtherDescription} placeholder="Please describe*" className={`mt-1 block w-full px-3 py-2 border rounded-md shadow-sm placeholder-neutral-400/60 focus:outline-none focus:ring-primary-color focus:border-primary-color sm:text-sm dark:bg-neutral-700 dark:text-white dark:placeholder-neutral-500/60 ${errors.otherDescription ? 'border-red-500 dark:border-red-400' : 'border-neutral-300 dark:border-neutral-600'}`} value={formData.otherDescription} onChange={handleChange} onBlur={handleBlur} aria-invalid={errors.otherDescription ? "true" : "false"} aria-describedby={errors.otherDescription ? "otherDescription-error" : undefined}></textarea>
                  ...
                  <fieldset className="space-y-2">
                    ...
                    <div className="flex items-center">
                      <input id="privacyPolicy" name="privacyPolicy" type="checkbox" required checked={formData.privacyPolicy} onChange={handleCheckboxChange} className={`h-4 w-4 text-primary-color border-neutral-300 rounded focus:ring-primary-color dark:bg-neutral-700 dark:border-neutral-600 ${errors.privacyPolicy ? 'border-red-500 dark:border-red-400' : 'border-neutral-300 dark:border-neutral-600'}`} aria-invalid={errors.privacyPolicy ? "true" : "false"} aria-describedby={errors.privacyPolicy ? "privacyPolicy-error" : undefined}/>
                      <label htmlFor="privacyPolicy" className="ml-3 block text-sm text-neutral-700 dark:text-neutral-300">
                        I agree to the <react_router_dom_1.Link to="/privacy-policy" className="text-primary-color hover:underline">Privacy Policy</react_router_dom_1.Link>*
                      </label>
                    </div>
                    ...
                    <div className="flex items-center">
                      <input id="marketingConsent" name="marketingConsent" type="checkbox" checked={formData.marketingConsent} onChange={handleCheckboxChange} className="h-4 w-4 text-primary-color border-neutral-300 rounded focus:ring-primary-color dark:bg-neutral-700 dark:border-neutral-600"/>
                  ...
                  <div className="flex justify-end space-x-3">
                    <Button_1.default type="reset" variant="outline" disabled={isLoading}>
                      Clear
                    </Button_1.default>
                    <Button_1.default type="submit" variant="primary" disabled={isLoading} loading={isLoading}>
...
exports.default = SchedulingContactSection;
//# sourceMappingURL=SchedulingContactSection.jsx.map