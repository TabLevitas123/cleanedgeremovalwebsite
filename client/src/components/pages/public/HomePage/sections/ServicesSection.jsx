...
const ServiceCard_1 = __importDefault(require("../../../../molecules/ServiceCard")); // Corrected path again
const Button_1 = __importDefault(require("../../../../atoms/Button")); // This path should be correct
...
const ServicesSection = () => {
    ...
    className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 max-w-7xl mx-auto" // Centered with max-width
     variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} // Trigger early for grid
    >
          {services.map((service) => (<framer_motion_1.motion.div key={service.id} variants={fadeIn}>
              <ServiceCard_1.default title={service.title} description={service.description} icon={service.icon} // Pass icon name/reference
        ...
        <div className="text-center mt-12">
          <react_router_dom_1.Link to="/services"> {/* Link to a potential dedicated services page */}
            <Button_1.default variant="primary" icon="grid" iconPosition="left">
              View All Services
            </Button_1.default>
...
//# sourceMappingURL=ServicesSection.jsx.map