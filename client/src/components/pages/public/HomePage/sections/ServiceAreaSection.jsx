      ...
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <div className="mt-4">
              ...
              <div className="flex gap-2">
                <input type="text" id="address-checker" placeholder="Enter your address" className="flex-grow px-3 py-2 border border-neutral-300 rounded-md focus:outline-none focus:ring-primary-color focus:border-primary-color dark:bg-neutral-800 dark:border-neutral-600 dark:text-white"/>
                <Button_1.default variant="primary">Check</Button_1.default>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3 max-w-4xl mx-auto mb-12">
            {serviceAreas.map((area) => (<div key={area} className="bg-neutral-100 dark:bg-neutral-800 rounded-full py-2 px-4" // Use rounded-full for pill shape
        >
          ...
          <react_router_dom_1.Link to="/service-areas"> {/* Link to potential dedicated service areas page */}
            <Button_1.default variant="outline" icon="map-pin" iconPosition="left">
...
exports.default = ServiceAreaSection;
//# sourceMappingURL=ServiceAreaSection.jsx.map