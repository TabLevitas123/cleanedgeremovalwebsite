 ...
 *
 * Layout template for admin dashboard pages.
...
const AdminLayout = () => {
    ...
    const navLinks = [
        ...
        { path: '/admin/services', label: 'Services', icon: 'tool' },
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              {/* Notifications */}
              <Button_1.default variant="text" icon="bell" aria-label="Notifications" onClick={() => navigate('/admin/notifications')}/>
